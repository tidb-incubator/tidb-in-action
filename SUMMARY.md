...
* [6 业务适配最佳实践](session4/chapter6/workload-adaptation-best-practices.md)
    ...
    * [6.4 分区表实践及问题处理](session4/chapter6/partition-table-best-practices.md)
        * [6.4.1 TiDB分区表简介](session4/chapter6/partition-table-best-practices.md) @代晓磊
        * [6.4.2 TiDB分区表使用场景](session4/chapter6/partition-table-best-practices.md) @代晓磊
        * [6.4.3 TiDB分区表最佳实践](session4/chapter6/partition-table-best-practices.md) @代晓磊
